...
*/
    ...
    Eigen::Vector3d endEffectorXYW = Eigen::Vector3d(2, 0 ,0);
    ...
    endEffectorXYW = Eigen::Vector3d(1.866, 1.5, 0.0);
    ...
    // std::vector<Eigen::Vector3d> jointAngles2NR = robot->solveInverseKinematics2Solution(desiredPosition);
    // robot->setLinkLengths(Eigen::Vector3d(5.0, 5.0, 6.0)); // Set link lengths
    // jointAngles2NR = robot->solveInverseKinematics2Solution(desiredPosition);
