\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md225}{}\doxysection{Introduction\+: Why googletest?}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md225}
...
Since googletest is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used J\+Unit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md226}{}\doxysection{Beware of the nomenclature}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md226}
...
\end{longtabu}
\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md227}{}\doxysection{Basic Concepts}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md227}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md228}{}\doxysection{Assertions}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md228}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the Assertions Reference.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md229}{}\doxysection{Simple Tests}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md229}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md230}{}\doxysection{Invoking the Tests}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md230}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md231}{}\doxysection{Writing the main() Function}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md231}
...
\{\+: .callout .note\} N\+O\+TE\+: {\ttfamily Parse\+G\+Unit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md232}{}\doxysection{Known Limitations}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_primer_autotoc_md232}
