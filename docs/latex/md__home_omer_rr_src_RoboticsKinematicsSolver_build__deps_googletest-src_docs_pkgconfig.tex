...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_pkgconfig_autotoc_md217}{}\doxysubsection{C\+Make}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_pkgconfig_autotoc_md217}
...
pkg-\/config will also try to look in {\ttfamily P\+K\+G\+\_\+\+C\+O\+N\+F\+I\+G\+\_\+\+P\+A\+TH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_pkgconfig_autotoc_md219}{}\doxysubsection{Using pkg-\/config in a cross-\/compilation setting}\label{md__home_omer_rr_src_RoboticsKinematicsSolver_build__deps_googletest-src_docs_pkgconfig_autotoc_md219}
